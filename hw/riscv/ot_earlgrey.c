...
static const IbexDeviceDef ot_eg_soc_devices[] = {
    ...
    [OT_EG_SOC_DEV_LC_CTRL] = {
        ...
        .gpio = IBEXGPIOCONNDEFS(
            ...
            OT_EG_SOC_SIGNAL(OT_LC_BROADCAST, OT_LC_OWNER_SEED_SW_RW_EN, FLASH_CTRL,
                             OT_LC_BROADCAST, OT_FLASH_LC_OWNER_SEED_SW_RW_EN),
            OT_EG_SOC_SIGNAL(OT_LC_BROADCAST, OT_LC_SEED_HW_RD_EN, FLASH_CTRL,
                             OT_LC_BROADCAST, OT_FLASH_LC_SEED_HW_RD_EN),
            OT_EG_SOC_SIGNAL(OT_LC_BROADCAST, OT_LC_ISO_PART_SW_RD_EN, FLASH_CTRL,
                             OT_LC_BROADCAST, OT_FLASH_LC_ISO_PART_SW_RD_EN),
            OT_EG_SOC_SIGNAL(OT_LC_BROADCAST, OT_LC_ISO_PART_SW_WR_EN, FLASH_CTRL,
                             OT_LC_BROADCAST, OT_FLASH_LC_ISO_PART_SW_WR_EN),
