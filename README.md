...
[![.github/workflows/build_test.yaml](https://github.com/lowRISC/qemu/actions/workflows/build_test.yaml/badge.svg?branch=ot-darjeeling-9.2.0)](https://github.com/lowRISC/qemu/actions/workflows/build_test.yaml)
...
This branch contains a fork of QEMU 9.2.0 dedicated to support lowRISC Ibex platforms:
  ...
  * [OpenTitan](https://opentitan.org) [EarlGrey](docs/opentitan/earlgrey.md) with FPGA "Bergen Board"
    CW310 memory map, no longer under active QEMU development. See https://github.com/lowRISC/qemu
    for newer EarlGrey version.
